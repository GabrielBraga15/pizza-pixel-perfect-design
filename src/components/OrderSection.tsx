    ...
    <section className="py-20 bg-pizza-primary text-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-xl mb-10 max-w-2xl mx-auto opacity-90">
          Entrega rápida, pizza quente e sabor incomparável. Faça seu pedido
          online ou por telefone e desfrute do melhor da culinária italiana.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="bg-white bg-opacity-10 p-8 rounded-lg hover:bg-opacity-20 transition-all">
            ...
            <p className="mb-6 opacity-80">
              Faça seu pedido pelo nosso site ou aplicativo com apenas alguns
              cliques
            </p>
            <Button
              variant="outline"
              className="border-white text-pizza-primary hover:bg-white hover:text-pizza-primary"
            >
          ...
          <div className="bg-white bg-opacity-10 p-8 rounded-lg hover:bg-opacity-20 transition-all">
            ...
            <p className="mb-6 opacity-80">
              Venha desfrutar do nosso ambiente aconchegante e atendimento
              especial
            </p>
            <Button
              variant="outline"
          ...
          <div className="bg-white bg-opacity-10 p-8 rounded-lg hover:bg-opacity-20 transition-all">
            ...
            <p className="mb-6 opacity-80">
              Prefere pedir por telefone? Nossa equipe está pronta para
              atendê-lo
            </p>
            <Button
              variant="outline"
